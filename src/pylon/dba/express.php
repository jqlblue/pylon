...
{/*{{{*/
    ...
    function generateSql($stgs = null)
    {
        return $this->_txtSql;
    }
}/*}}}*/
...
{/*{{{*/
    ...
    {
        return new UserFunStg(create_function('$col,$val','return !empty($val);'));
    }
    /** 
     * @brief 过滤为NULL的值.
     * 
    ...
    {
        return new UserFunStg(create_function('$col,$val','return !is_null($val);'));
    }
}/*}}}*/
